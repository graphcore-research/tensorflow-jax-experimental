...
#define ARITHMETIC_EXPR_VISITOR_UNIMPLEMENTED(Name) \
  ...
  ARITHMETIC_EXPR_VISITOR_UNIMPLEMENTED(HandleReduceScatter);
  ARITHMETIC_EXPR_VISITOR_UNIMPLEMENTED(HandleAllReduceStart);
  ARITHMETIC_EXPR_VISITOR_UNIMPLEMENTED(HandleAllReduceDone);
  ARITHMETIC_EXPR_VISITOR_UNIMPLEMENTED(HandleAllGatherStart);
  ARITHMETIC_EXPR_VISITOR_UNIMPLEMENTED(HandleAllGatherDone);

  ARITHMETIC_EXPR_VISITOR_UNIMPLEMENTED(HandleOptimizationBarrier)
  ARITHMETIC_EXPR_VISITOR_UNIMPLEMENTED(HandleAsyncStart)
  ARITHMETIC_EXPR_VISITOR_UNIMPLEMENTED(HandleAsyncUpdate)
  ARITHMETIC_EXPR_VISITOR_UNIMPLEMENTED(HandleAsyncDone)
