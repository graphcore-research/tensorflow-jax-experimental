...
#define UNIMPLEMENTED(Name) \
  ...
  // DriverProgramSequence can be passed directly since it is implicitly
  // convertible to a DriverProgramSequence.
  virtual Status AddSequenceForInstruction(const HloInstruction* inst,
 ...
 private:
  Status CreateSequenceGroupedByInstruction(const HloInstruction* inst,
                                            const DriverProgramSequence& seq);

  std::vector<std::list<DriverProgramSequence>> sequences_;
